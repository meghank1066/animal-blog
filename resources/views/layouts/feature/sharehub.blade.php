...
<div class='custom-img'>
    <div class="custom-container ">
        <h2 class="text-2xl font-bold py-10"><img src="./images/font.png" style="width: 500px; padding-left: 30%;"></h2>
        <div class="gallery">
                ...
                <div class="image-container relative">
                    ...
                    <div class="button-container">
                        <div class="description-container">
                            ...
                            <input type="text" name="description" value="{{ $image->image_description }}" class="form-input w-full border border-gray-300 rounded-md px-4 py-2 mb-4 hidden" id="edit_{{ $image->id }}">
                        </div>
                        <div class="action-buttons">
                            <form action="{{ route('delete', $image) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="delete-button bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded">
